...
function Drag(opts){
    this.opts={
        ...
        targetEle: '',
        maxTop: 100,
        targetHitColor: '#b17a6f',
        targetOriColor: '#989f9c',
        ondrag: function (obj) {}
    };
...
Drag.prototype.setEvent = function(){
    ...
    var endHandler = function(e){
        ...
        //隐藏H5FullScreen的遮罩层
        setTimeout(function(){
            if($('.overlay').length > 0) $('.overlay').hide();
        },500);
    };
...
Drag.prototype.checkHit = function (obj) {
    ...
    if (obj.left >= self.targetLeft && obj.left <= self.targetLeft + self.targetWidth &&
        ...
        self.targetEle.style.cssText += 'background-color:' + self.opts.targetHitColor;
        obj.isHit = true;
        ...
        self.opts.ondrag.call(self, obj);
        self.targetEle.style.cssText += 'background-color:' + self.opts.targetOriColor;
    }
...
Drag.prototype.destroy = function(){
    console.log(this);
    this.dragEle.removeEventListener("touchstart",function(){},false);
    this.dragEle.removeEventListener("touchmove",function(){},false);
    this.dragEle.removeEventListener("touchend",function(){},false);
    this.dragEle = null;
    this.targetEle = null;
    this.opts = {};
};
